<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 sm:gap-3">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-white leading-tight">{{ __('Laporan Rencana Pengiriman Driver') }}</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{{ $periodLabel }}</p>
            </div>
            @include('reports.partials.export-buttons', [
                'exportType' => 'driver-routes',
                'exportFilename' => 'Laporan Rencana Pengiriman Driver',
            ])
        </div>
    </x-slot>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div id="sw-filter-card" class="sw-report-filter bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-4 sm:p-5 mb-6">
            <form method="GET" action="{{ route('admin.reports.driver-routes') }}" class="space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 gap-y-3 items-end">
                    <div class="lg:col-span-3">
                        ...
                        <input type="text" name="search" value="{{ request('search', $search ?? '') }}" placeholder="Nama rute, driver, toko..."
                    ...
                    <div class="lg:col-span-2 flex flex-col sm:flex-row sm:items-end justify-end gap-2">
                        ...
                        <a href="{{ route('admin.reports.driver-routes') }}"
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-5">
                <p class="text-xs text-gray-500 dark:text-gray-400 mb-1.5">Target Tujuan</p>
                <p class="text-xl font-bold text-amber-600 dark:text-amber-400">{{ $stats['total_stops'] }}</p>
            </div>
            <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-5">
                <p class="text-xs text-gray-500 dark:text-gray-400 mb-1.5">Tujuan Terkirim</p>
                ...
                <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
                    <thead class="bg-gray-50 dark:bg-gray-800/50">
                        <tr>
                            ...
                            <th class="px-4 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Rute Pengiriman</th>
                            ...
                            <th class="px-4 py-3.5 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Target Tujuan</th>
                            <th class="px-4 py-3.5 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Terkirim</th>
                            ...
                            <th class="px-4 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Daftar Tujuan / Urutan</th>
                    ...
                    <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                        ...
                        <tr>
                            <td colspan="11" class="px-6 py-14 text-center">
                                ...
                                <p class="mt-3 text-sm text-gray-500 dark:text-gray-400">Belum ada rencana pengiriman</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
