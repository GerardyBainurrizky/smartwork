<x-app-layout>
    <x-slot name="header">
        <x-page-header icon="plus" title="Tambah Pengguna" subtitle="Tambahkan akun pengguna baru ke sistem">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
            <div class="p-5 sm:p-7">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h1 class="text-lg font-bold text-gray-900 dark:text-white">Tambah Pengguna</h1>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Lengkapi data akun pengguna baru di bawah ini.</p>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        {{-- Password --}}
                        <div>
                            <label for="password" class="{{ $labelClass }}">Password {!! $req !!}</label>
                            ...
                            @else
                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1.5">Gunakan minimal 8 karakter.</p>
                            @enderror
                        </div>

                        {{-- Konfirmasi Password --}}
                        <div>
                            <label for="password_confirmation" class="{{ $labelClass }}">Konfirmasi Password {!! $req !!}</label>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-1 grid grid-cols-1 sm:grid-cols-2 gap-3" x-data="{ status: '{{ old('status', 'active') }}' }">
